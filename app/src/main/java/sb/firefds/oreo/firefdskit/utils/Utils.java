 ...
 */
package sb.firefds.oreo.firefdskit.utils;
...
public class Utils {
    ...
    public static void resetPermissions(Context context) {
        executeScript(context, "reset_permissions.sh");
    }

    public static void createCSCFiles(Context context) {
        switch (getCSCType()) {
            case CSC:
                executeScript(context, "create_csc_files.sh");
                break;
            case OMC_CSC:
                executeScript(context, "create_omc_csc_files.sh");
                break;
            case OMC_OMC:
                executeScript(context, "create_omc_omc_files.sh");
                break;
        }
    }
    ...
    public static void applyCSCFeatues(Context context) {
        switch (getCSCType()) {
            case CSC:
                executeScript(context, "apply_csc_features.sh");
                break;
            case OMC_CSC:
                executeScript(context, "apply_omc_csc_features.sh");
                break;
            case OMC_OMC:
                executeScript(context, "apply_omc_omc_features.sh");
                break;
        }
    }
    ...
    private static void rebootSystem(final Context context, final String rebootType) {
        new Handler().postDelayed(() -> {
            try {
                ...
                Objects.requireNonNull(pm).reboot(rebootType);
    ...
    public static void disableVolumeControlSounds(Context context) {
        if (new File("/system/media/audio/ui/TW_Volume_control.ogg").isFile()) {
            executeScript(context, "disable_volume_sounds.sh");
        }
    }
    ...
    public static void setTypeface(XSharedPreferences prefs, TextView tv) {
    ...
    public static CscType getCSCType() {
        if (mCscType != null)
            return mCscType;
        mCscType = SystemProp.getBoolean(OMC_SUPPORT, false) ? CscType.OMC_OMC : CscType.OMC_CSC;
        return mCscType;
    }

    static String getOMCPath() {
        return SystemProp.get(OMC_PATH);
    }
