...
import static sb.firefds.s.firefdskit.utils.Constants.EMERGENCY_ACTION;
import static sb.firefds.s.firefdskit.utils.Constants.FLASHLIGHT_ACTION;
import static sb.firefds.s.firefdskit.utils.Constants.MULTIUSER_ACTION;
import static sb.firefds.s.firefdskit.utils.Constants.POWER_ACTION;
import static sb.firefds.s.firefdskit.utils.Constants.RECOVERY_ACTION;
import static sb.firefds.s.firefdskit.utils.Constants.RESTART_ACTION;
import static sb.firefds.s.firefdskit.utils.Constants.RESTART_UI_ACTION;
import static sb.firefds.s.firefdskit.utils.Constants.SCREENSHOT_ACTION;
...
import static sb.firefds.s.firefdskit.utils.Preferences.PREF_CUSTOM_RECOVERY;
import static sb.firefds.s.firefdskit.utils.Preferences.PREF_CUSTOM_RECOVERY_CONFIRMATION;
import static sb.firefds.s.firefdskit.utils.Preferences.PREF_DISABLE_POWER_MENU_SECURE_LOCKSCREEN;
import static sb.firefds.s.firefdskit.utils.Preferences.PREF_DISABLE_RESTART_CONFIRMATION;
import static sb.firefds.s.firefdskit.utils.Preferences.PREF_ENABLE_ADVANCED_POWER_MENU;
import static sb.firefds.s.firefdskit.utils.Preferences.PREF_ENABLE_DATA_MODE;
import static sb.firefds.s.firefdskit.utils.Preferences.PREF_ENABLE_DOWNLOAD;
import static sb.firefds.s.firefdskit.utils.Preferences.PREF_ENABLE_EMERGENCY_MODE;
import static sb.firefds.s.firefdskit.utils.Preferences.PREF_ENABLE_FLASHLIGHT;
import static sb.firefds.s.firefdskit.utils.Preferences.PREF_ENABLE_POWER_OFF;
import static sb.firefds.s.firefdskit.utils.Preferences.PREF_ENABLE_RECOVERY;
import static sb.firefds.s.firefdskit.utils.Preferences.PREF_ENABLE_RESTART;
import static sb.firefds.s.firefdskit.utils.Preferences.PREF_ENABLE_RESTART_SYSTEMUI;
import static sb.firefds.s.firefdskit.utils.Preferences.PREF_ENABLE_SCREENSHOT;
import static sb.firefds.s.firefdskit.utils.Preferences.PREF_ENABLE_SCREEN_RECORD;
