...
public class XPM23 {
    ...
    private static final String PERM_ACCESS_SURFACE_FLINGER =
                        ...
                        protected void afterHookedMethod(MethodHookParam param) {
                            ...
                            if (Packages.FIREFDSKIT.equals(pkgName)) {
                                ...
                                if (!(Boolean) XposedHelpers
                                        .callMethod(ps, "hasInstallPermission", REBOOT)) {
                                    final Object pAccess = XposedHelpers
                                            .callMethod(permissions, "get", REBOOT);
                                    XposedHelpers
                                            .callMethod(ps, "grantInstallPermission", pAccess);
                                }

                                if (!(Boolean) XposedHelpers.callMethod(ps,
                                        "hasInstallPermission",
                                        INTERACT_ACROSS_USERS_FULL)) {
                                    final Object pAccess = XposedHelpers.callMethod(permissions,
                                            "get",
                                            INTERACT_ACROSS_USERS_FULL);
