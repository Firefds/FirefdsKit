...
import sb.firefds.r.firefdskit.dialogs.CreditDialog;
import sb.firefds.r.firefdskit.dialogs.RestoreDialog;
import sb.firefds.r.firefdskit.dialogs.SaveDialog;
import sb.firefds.r.firefdskit.fragments.FirefdsPreferenceFragment;
import sb.firefds.r.firefdskit.fragments.PreferenceFragmentFactory;
import sb.firefds.r.firefdskit.notifications.RebootNotification;
import sb.firefds.r.firefdskit.utils.Utils;

import static sb.firefds.r.firefdskit.utils.Constants.DISABLE_PHONE_NUMBER_FORMATTING;
import static sb.firefds.r.firefdskit.utils.Constants.DISABLE_SMS_TO_MMS_CONVERSION_BY_TEXT_INPUT;
import static sb.firefds.r.firefdskit.utils.Constants.FORCE_CONNECT_MMS;
import static sb.firefds.r.firefdskit.utils.Constants.PREFS;
import static sb.firefds.r.firefdskit.utils.Constants.SHORTCUT_PHONE;
import static sb.firefds.r.firefdskit.utils.Constants.SHORTCUT_SECURITY;
import static sb.firefds.r.firefdskit.utils.Constants.SHORTCUT_STATUSBAR;
import static sb.firefds.r.firefdskit.utils.Constants.SHORTCUT_SYSTEM;
import static sb.firefds.r.firefdskit.utils.Preferences.PREF_DATA_ICON_BEHAVIOR;
import static sb.firefds.r.firefdskit.utils.Preferences.PREF_DISABLE_NUMBER_FORMATTING;
import static sb.firefds.r.firefdskit.utils.Preferences.PREF_DISABLE_SMS_TO_MMS;
import static sb.firefds.r.firefdskit.utils.Preferences.PREF_FIRST_LAUNCH;
import static sb.firefds.r.firefdskit.utils.Preferences.PREF_FORCE_MMS_CONNECT;
import static sb.firefds.r.firefdskit.utils.Preferences.PREF_NFC_BEHAVIOR;
import static sb.firefds.r.firefdskit.utils.Preferences.PREF_SCREEN_TIMEOUT_HOURS;
import static sb.firefds.r.firefdskit.utils.Preferences.PREF_SCREEN_TIMEOUT_MINUTES;
import static sb.firefds.r.firefdskit.utils.Preferences.PREF_SCREEN_TIMEOUT_SECONDS;
import static sb.firefds.r.firefdskit.utils.Utils.checkForceEnglish;
import static sb.firefds.r.firefdskit.utils.Utils.isDeviceEncrypted;
import static sb.firefds.r.firefdskit.utils.Utils.isNotSamsungRom;
import static sb.firefds.r.firefdskit.utils.Utils.log;
