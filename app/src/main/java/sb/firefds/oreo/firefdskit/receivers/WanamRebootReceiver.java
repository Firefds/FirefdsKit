...
import sb.firefds.oreo.firefdskit.activities.WanamRebootActivity;
...
public class WanamRebootReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Objects.requireNonNull(action).equalsIgnoreCase(REBOOT_DEVICE) || action.equalsIgnoreCase(SOFT_REBOOT_DEVICE)
