...
public class DVFSBlackListDialog extends DialogFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String[] whiteArray = Objects.requireNonNull(MainApplication.getSharedPreferences()
                .getString("enableDVFSBlackList", ""))
                .split(";");
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        return builder.setMultiChoiceItems(appsLabelArray, appsCheckedArray, listener)
                .setCancelable(true)
                .setTitle(R.string.dvfs_black_list)
