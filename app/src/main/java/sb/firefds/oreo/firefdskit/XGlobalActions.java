...
public class XGlobalActions {
    private static final String CLASS_GLOBAL_ACTIONS = "com.android.systemui.globalactions.GlobalActionsDialog";
    private static final String CLASS_ACTION = CLASS_GLOBAL_ACTIONS + ".Action";
