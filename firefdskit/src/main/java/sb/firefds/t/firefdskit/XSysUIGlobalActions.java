...
import static sb.firefds.t.firefdskit.actionViewModels.FirefdsKitActionViewModelsFactory.getActionViewModel;
...
import static sb.firefds.t.firefdskit.utils.Constants.RECOVERY_ACTION;
import static sb.firefds.t.firefdskit.utils.Constants.RESTART_ACTION;
import static sb.firefds.t.firefdskit.utils.Constants.RESTART_UI_ACTION;
import static sb.firefds.t.firefdskit.utils.Constants.SCREENSHOT_ACTION;
import static sb.firefds.t.firefdskit.utils.Constants.SCREEN_RECORD_ACTION;
import static sb.firefds.t.firefdskit.utils.Packages.SYSTEM_UI;
import static sb.firefds.t.firefdskit.utils.Preferences.PREF_CUSTOM_RECOVERY;
import static sb.firefds.t.firefdskit.utils.Preferences.PREF_CUSTOM_RECOVERY_CONFIRMATION;
import static sb.firefds.t.firefdskit.utils.Preferences.PREF_DISABLE_POWER_MENU_SECURE_LOCKSCREEN;
import static sb.firefds.t.firefdskit.utils.Preferences.PREF_DISABLE_RESTART_CONFIRMATION;
import static sb.firefds.t.firefdskit.utils.Preferences.PREF_ENABLE_ADVANCED_POWER_MENU;
import static sb.firefds.t.firefdskit.utils.Preferences.PREF_ENABLE_DATA_MODE;
import static sb.firefds.t.firefdskit.utils.Preferences.PREF_ENABLE_DOWNLOAD;
import static sb.firefds.t.firefdskit.utils.Preferences.PREF_ENABLE_EMERGENCY_MODE;
import static sb.firefds.t.firefdskit.utils.Preferences.PREF_ENABLE_FLASHLIGHT;
import static sb.firefds.t.firefdskit.utils.Preferences.PREF_ENABLE_POWER_OFF;
import static sb.firefds.t.firefdskit.utils.Preferences.PREF_ENABLE_RECOVERY;
import static sb.firefds.t.firefdskit.utils.Preferences.PREF_ENABLE_RESTART;
import static sb.firefds.t.firefdskit.utils.Preferences.PREF_ENABLE_RESTART_SYSTEMUI;
import static sb.firefds.t.firefdskit.utils.Preferences.PREF_ENABLE_SCREENSHOT;
import static sb.firefds.t.firefdskit.utils.Preferences.PREF_ENABLE_SCREEN_RECORD;
import static sb.firefds.t.firefdskit.utils.Preferences.PREF_REPLACE_RECOVERY_ICON;
import static sb.firefds.t.firefdskit.utils.Preferences.PREF_SUPPORTS_MULTIPLE_USERS;
import static sb.firefds.t.firefdskit.utils.Preferences.PREF_UNLOCK_KEYGUARD_BEFORE_ACTION_EXECUTE;
...
import sb.firefds.t.firefdskit.actionViewModels.ActionViewModelDefaults;
